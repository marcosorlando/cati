    ...
    $('html').on('change', 'form.auto_save', function (e) {
        ...
        form.ajaxSubmit({
            ...
            success: function (data) {
                ...
                if (data.city) {
                    var CallBackPresent = $('.cities_return');
                    if (CallBackPresent.length) {
                        CallBackPresent.html(data.city);
                ...
                if (data.allcities) {
                    var CallBackPresent = $('.allcities');
                    if (CallBackPresent.length) {
                        CallBackPresent.html(data.allcities);
                        $('.allcities').fadeIn('slow');
                    } else {
                        Trigger(data.allcities);
                    }
                }

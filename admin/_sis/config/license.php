...
<div class="dashboard_content">
    ...
    if (file_exists("dashboard.json")):
        ...
        . "<p class='title'>Zen Control® Licenciado por <a title='Conferir Profissional' href='https://pro.workcontrol.com.br/?p={$License->user_id}' target='_blank'>{$License->user_name} {$License->user_lastname}</a></p>"

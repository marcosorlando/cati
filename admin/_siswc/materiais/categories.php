...
if (DB_AUTO_TRASH):
    $Delete = new Delete;
    $Delete->ExeDelete(DB_MATCATEGORIES, "WHERE category_title IS NULL AND category_content IS NULL AND category_id >= :st", "st=1");
endif;
?>
...
<div class="dashboard_content">
    ...
    if (!$Read->getResult()):
        ...
        foreach ($Read->getResult() as $Sess):
            ...
            $Read->ExeRead(DB_MATCATEGORIES, "WHERE category_parent = :cid ORDER BY category_title ASC", "cid={$Sess['category_id']}");
            if ($Read->getResult()):

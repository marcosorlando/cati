...
<div class="footer-main-section w-100 float-left padding-top">
	<div class="container">
		<div class="footer-inner-con">
			<div class="footer-logo-box">
				<a href="<?= BASE; ?>">
					<figure>
						<img src="<?= INCLUDE_PATH; ?>/assets/images/header-logo.png" alt="header-logo">
					</figure>
				</a>
				<p><?= SITE_DESC ?></p>
				<div class="header-contact-btn">
					<a href="<?= Check::WhatsMessage(SITE_ADDR_WHATS,
						'Olá! Cati, estou no seu site, quero saber mais sobre sua campanha a vereadora por Caxias do Sul') ?>"><i
								class="fas
					fa-phone-alt"></i><?=
							SITE_ADDR_PHONE_A ?></a>
				</div>
			...
			<div class="footer-list-box footer-contact-box">
				<span class="small-txt d-block position-relative">Contate-me</span>
				<ul class="list-unstyled">
					<li class="position-relative location"><i class="fas fa-map-marked-alt"></i> <a
								href="https://maps.app.goo.gl/oc3xfXkbZdugBWbp6" target="_blank"> Av. Júlio de
							Castilhos, 1393,
							Centro - Caxias do Sul</a></li>
					<li class="position-relative mail-address"><i class="fas fa-envelope"></i> <a
		...
		<div class="copyright-inner-con">
			<p class="mb-0">Eleição Municipal 2024 - <span class="d-inline-block">Catiane Zanotto - 11112</span> -
				COLIGAÇÃO O FUTURO É AGORA-PL-PP-NOVO-PODEMOS | CNPJ: 56.363.408/0001-82
				.</p>
		</div>
	</div>
</div>

			...
			<form class="form-box j_formsubmit" method="post" id="contact_index" method="post"
				...
				<div class="form-inputs-con">
					<ul class="list-unstyled w-100 float-left mb-0">
						...
						<li data-aos="fade-up" data-aos-duration="700">
							<label>Email:</label>
							<input type="email" placeholder="Seu melhor e-mail:" name="voluntary_email" id="voluntary_email">
						</li>
						<li data-aos="fade-up" data-aos-duration="700">
							<label>Whatsapp:</label>
							<input type="tel" placeholder="Seu número de telefone:" name="voluntary_phone" id="voluntary_phone">
						</li>
					</ul>
					<ul class="list-unstyled w-100 float-left mb-0">
						<li data-aos="fade-up" data-aos-duration="700">
						...
						<li data-aos="fade-up" data-aos-duration="700">
							...
							<textarea placeholder="Escreva sua mensagem" name="voluntary_message" id="voluntary_message"></textarea>
						</li>
					</ul>
				</div>
				<label for="privacy" class="label_check mb-3 text-size-14">
					<input type="checkbox" id="privacy" name="privacy" required>
					<span> <b class="text-red" style="font-size: 1.3em">*</b>Consinto com a <a
				...
				<div class="submit-btn" data-aos="fade-up" data-aos-duration="700">
					<button type="submit" id="submit"><i class="fa fa-users"></i><img class="form_load" src="<?=
							INCLUDE_PATH
